...
export default function BisnesSection({ data }: { data: any }) {
  ...
  return (
    <section className="my-8">
      ...
      <div className="border-t pt-4 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 divide-y md:divide-y-0">
        {subPosts.map((post: any) => {
          if (typeof post !== 'object') return null
          return (
            <div key={post.id} className="pt-3 md:pt-0 border-b border-gray-100 pb-3">
              <Link
